...
public class DrawTextBox extends DrawCommand {
	...
	private static String PROPERTY_NAME_LINK = "link";
	...
	public DrawTextBox(Boolean visible, Double distance, String title,
		...
		setProperty(PROPERTY_NAME_LINK, link);
	...
	public void draw(PaintScreen dw) {
		...
		String link = getStringProperty(PROPERTY_NAME_LINK);
		...
		dw.paintText3D(tekst, link, new PointF(signMarker.x, signMarker.y), 0);
